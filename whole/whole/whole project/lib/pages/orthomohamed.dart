...
void main() {
  runApp(MaterialApp(home: Orthomohamed()));
}

class Orthomohamed extends StatelessWidget {
  @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+200882330500'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ...
        : 'Al-Hamra 2, First Section, Assiut University.',
