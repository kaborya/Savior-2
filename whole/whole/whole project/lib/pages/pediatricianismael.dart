...
void main() {
  runApp(MaterialApp(home: Pediatricianismael()));
}

class Pediatricianismael extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001067353767'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Professor of Pediatrics and Neonatology, Intensive Care Consultant.'
        : 'Yousry Ragheb, the highest Turkish juice.',
