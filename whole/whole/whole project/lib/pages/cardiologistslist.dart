...
void main() {
  runApp(MaterialApp(home: Cardiologistslist()));
}

class Cardiologistslist extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final List<Map<String, String>> doctors = [
      {'name': 'Dr. Ahmed Mahran', 'specialty': 'Cardiologist', 'experience': '2 years'},
      {'name': 'Dr. George William \n Ajban', 'specialty': 'Cardiologist', 'experience': '5 years'},
      {'name': 'Dr. Michael Atef \n Fouad', 'specialty': 'Cardiologist', 'experience': '8 years'},
      {'name': 'Dr. Khaled Al-Maghribi', 'specialty': 'Cardiologist', 'experience': '3 years'},
    ];
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        // BACK BUTTON (Updated to match the exact working code)
                        Container(
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  if (name.contains('Ahmed')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Cardiologistahmed()));
                                  } else if (name.contains('George')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Cardiologistgeorge()));
                                  } else if (name.contains('Khaled')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Cardiologistkhaled()));
                                  } else if (name.contains('Michael')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Cardiologistmichael()));
                                  }
                                },
                                child: Container(
                                  width: 40,
