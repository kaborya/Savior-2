...
class Brufen extends StatelessWidget {
  @override
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDescription(
                      'It is one of the most popular medications used to relieve body aches and pains. It also has antipyretic and anti-inflammatory effects.'),
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildInfoItem('1-Heartburn'),
                      _buildInfoItem('2-Nausea'),
                      _buildInfoItem('3-Diarrhea'),
