...
void main() {
  runApp(Vomittinglist());
}

class Vomittinglist extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: VomittingScreen(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class VomittingScreen extends StatelessWidget {
  final List<Map<String, String>> medicineList = [
    {
      'name': 'Danset',
      'image': 'assets/images/danset.jpg',
    },
    {
      'name': 'Dompy',
      'image': 'assets/images/dompy.jpg',
    },
    {
      'name': 'Motilium',
      'image': 'assets/images/motilium.jpg',
    },
    {
      'name': 'Zofran',
      'image': 'assets/images/Zofran.jpg',
    },
  ];
