...
class Danset extends StatelessWidget {
  @override
                ...
                children: [
                  ...
                  Center(
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/danset.jpg',
                        width: isSmallScreen ? 300 : 70,
                        height: isSmallScreen ? 150 : 70,
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  _buildDescription(
                      'This treatment is used to reduce nausea and vomiting in the following cases: Nausea and vomiting associated with chemotherapy (antineotherapy), Nausea and vomiting associated with radiation therapy and Nausea and vomiting following surgery.'),
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildInfoItem('1-Diarrhea or constipation'),
                      _buildInfoItem('2-Headache'),
                      _buildInfoItem('3-Fatigue or exhaustion'),
