...
void main() {
  runApp(MaterialApp(home: Cardiologistgeorge()));
}

class Cardiologistgeorge extends StatelessWidget {
    @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001010909007'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Consultant Cardiologist, specializing in treating patients with coronary artery disease and heart attacks.'
        : 'Yousry Ragheb Street, Petroleum Tower, in front of Al-Rowwad Center.',
