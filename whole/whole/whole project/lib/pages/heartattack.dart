...
void main() => runApp(const Heartattack());
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Image.asset(
                        'assets/images/heart attack2.jpg',
                        height: 150,
                        errorBuilder: (context, error, stackTrace) =>
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 10),
                          Text(
                            "A heart attack is heart damage caused by reduced or blocked blood flow to the heart muscle.",
                            style: TextStyle(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 10),
                          TreatmentDropdown(
                            title: "1 -Have them stop activity and rest in a comfortable position.",
                            description: "",
                          ),
                          TreatmentDropdown(
                            title: "2 -Take aspirin, if recommended or If they have prescribed medication",
                            description: "",
                          ),
                          TreatmentDropdown(
                            title: "3 -Start CPR if the person doesn't have a pulse or isn't breathing",
                            description:
                                "",
                          ),
                        ],
