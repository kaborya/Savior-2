...
void main() {
  runApp(MaterialApp(home: Orthoessam()));
}

class Orthoessam extends StatelessWidget {
  @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001007735877'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Vice President of the International Society of Orthopedic Surgery. '
