...
import 'package:grad_project/pages/brufen.dart'; // Import your specific page for Brufen
import 'package:grad_project/pages/disflatyl.dart'; // Import your specific page for Disflatyl
import 'package:grad_project/pages/gaviscon.dart'; // Import your specific page for Gaviscon
import 'package:grad_project/pages/maalox.dart'; // Import your specific page for Maalox

void main() {
  runApp(Abdominallist());
}

class Abdominallist extends StatelessWidget {
  @override
...
class FluScreen extends StatelessWidget {
  final List<Map<String, String>> medicineList = [
    ...
    {
      'name': 'Disflatyl',
      'image': 'assets/images/disflatyl.jpg',
    },
    {
      'name': 'Gaviscon',
      'image': 'assets/images/gaviscon.jpg',
    },
    {
      'name': 'Maalox',
      'image': 'assets/images/maalox.jpg',
    },
  ];
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () {
                          ...
                          // Ensure Navigator.push uses the context properly
                          Navigator.push(
                            context,
