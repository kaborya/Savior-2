...
void main() {
  runApp(MaterialApp(home: Generalsurgeryromany()));
}

class Generalsurgeryromany extends StatelessWidget {
  @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001201111344'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'General Surgery Specialist at Assiut General Hospital.'
        : 'Commercial Towers, above Turkish Juice, Yasser Ragheb Extension.',
