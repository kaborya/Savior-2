...
void main() => runApp(const Choking());
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 10),
                          TreatmentDropdown(
                            title: "1 -Position self to the side and slightly behind the choking person",
                            description: "-For a small child, you may need to kneel behind them rather than stand",
                          ),
                          TreatmentDropdown(
                          ...
                          TreatmentDropdown(
                            title: "3 -If no improvement, have the person stand up straight.",
                            description:
                                "",
                          ),
                          TreatmentDropdown(
                            title: "4 -Move behind the person; bend your knees slightly for balance and support.",
                            description: "",
                          ),
                          TreatmentDropdown(
                            title: "5 -Give 5 abdominal thrusts.",
                            description: "-Pull inward and upward each time.",
                          ),
                          TreatmentDropdown(
                            title: "6 -Clear the airway. ",
                            description: "-If you can see the object, reach a finger into the mouth to sweep out the object. \n -Never finger sweep if you can't see the object",
                          ),
                          TreatmentDropdown(
                            title: "7 -Begin CPR if the person still doesn't respond",
                            description:
                                " ",
                          ),
