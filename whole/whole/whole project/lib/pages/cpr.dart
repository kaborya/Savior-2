                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 10),
                          TreatmentDropdown(
                            title: "1 -Chest Compressions:",
                            description: "-Place hands (one on top of the other) in the center of the chest.              "
                            "            -Push hard and fast (at least 2 inches deep, 100-120 compressions per minute).",
                          ),
                          TreatmentDropdown(
                            title: "2 -Give Rescue Breaths:",
                            description: "-Open the airway (tilt the head back, lift the chin).          "
                            "                              -Pinch the nose, give two breaths, each lasting about 1 second, making the chest rise.",
                          ),
                          TreatmentDropdown(
                            title: "3 -Continue CPR",
                            description:
                                "",
                          ),
