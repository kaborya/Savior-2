...
void main() {
  runApp(MaterialApp(home: Dentistatef()));
}

class Dentistatef extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001006169068'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ...
        : 'Youlio Farouk Sbekn 26, Al Hamraa Ath Thaneyah, Asyut 2',
