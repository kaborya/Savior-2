...
void main() {
  runApp(MaterialApp(home: Internalnour()));
}

class Internalnour extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001123747415'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Senior Consultant, Member of the Royal College of Physicians of Britain'
