...
void main() {
  runApp(MaterialApp(home: Internalbaha()));
}

class Internalbaha extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001003613763'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ...
        : 'Al-Safa Tower next to the Comprehensive Hospital, Al-Hamra 2, Assiut First Section, Assiut Governorate',
