...
void main() {
  runApp(MaterialApp(home: Internalwael()));
}

class Internalwael extends StatelessWidget {
  @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001093875719'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ...
        : 'Al Hamraa Ath Thaneyah, Asyut 2.',
