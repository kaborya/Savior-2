...
void main() {
  runApp(MaterialApp(home: Ophthwael()));
}

class Ophthwael extends StatelessWidget {
  @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001000111550'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Consultant in retinal and cataract surgeries. '
        : 'Al-Namis Street, in front of the Angel Church, Al-Jawhara Tower.',
