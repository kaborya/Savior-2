...
void main() {
  runApp(MaterialApp(home: Generalsurgeryahmedmohamed()));
}

class Generalsurgeryahmedmohamed extends StatelessWidget {
   @override
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          'Dr. Ahmed Mohamed Mahmoud Saad El-Din',
                          style: TextStyle(
                            fontSize: 20,
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001093050723'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Senior Consultant General Surgery, Doctor of General Surgery and Laparoscopic Surgery. '
        : 'First Thabet Street, in front of the East Building.',
