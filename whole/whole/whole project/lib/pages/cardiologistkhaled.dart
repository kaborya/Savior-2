...
void main() {
  runApp(MaterialApp(home: Cardiologistkhaled()));
}

class Cardiologistkhaled extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+200882361010'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ...
        : 'Assiut, Yousry Ragheb Street, Dr. Wagdy Tower.',
