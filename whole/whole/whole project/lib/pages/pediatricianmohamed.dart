...
void main() {
  runApp(MaterialApp(home: Pediatricianmohamed()));
}

class Pediatricianmohamed extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001017771212'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ...
        : 'Al-Walidiya, Assiut Second Section.',
