...
void main() {
  runApp(MaterialApp(home: Ophthpeter()));
}

class Ophthpeter extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001284811475'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Master of Ophthalmology and Laser Vision Correction Specialist.'
        : '26th of July Street, branching off from Yusra Ragheb Street, above Ihab Wahib Pharmacy.',
