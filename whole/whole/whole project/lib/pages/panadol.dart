            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDescription(
                      'An antipyretic used to treat fever. Fever is a temporary increase in body temperature. It is used to relieve mild to moderate pain, including various types of pain, particularly that which may occur with inflammation, such as colds and flu.'),

                  // Side Effects
                  const SizedBox(height: 40),
                  _buildSectionTitle('Side Effects'),
                  _buildDescription(
                      'The following side effects are not common to everyone, some patients may experience:'),
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildInfoItem('1-Vomiting'),
                      _buildInfoItem('2-Dizziness'),
                      _buildInfoItem('3-Nausea'),
                    ],
                  ),
                ],
              ),
