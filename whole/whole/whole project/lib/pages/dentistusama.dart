...
void main() {
  runApp(MaterialApp(home: Dentistusama()));
}

class Dentistusama extends StatelessWidget {
  @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001143341561'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Faculty of Dentistry, Al-Azhar University and Orthodontist'
        : 'Yousry Raghib Rd, Assiut Governorate',
