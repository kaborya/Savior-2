...
void main() {
  runApp(MaterialApp(home: Generalsurgeryahmedabdel()));
}

class Generalsurgeryahmedabdel extends StatelessWidget {
  @override
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001112294010'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Consultant General Surgery, Oncology, and Endoscopy.'
        : 'Al Amal Hospital, Lawyers, Division, behind Cook Door, Assiut.',
