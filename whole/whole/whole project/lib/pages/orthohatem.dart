...
void main() {
  runApp(MaterialApp(home: Orthohatem()));
}

class Orthohatem extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+200882372847'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Professor of Orthopedic Surgery and Fractures, Faculty of Medicine, Assiut University, and Consultant in Shoulder, Pelvis, and Knee Arthroscopic Surgery.'
        : 'Al-Hilali Al-Hamra 2nd Division, Assiut University.',
