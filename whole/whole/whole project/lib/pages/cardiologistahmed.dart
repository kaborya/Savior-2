...
void main() {
  runApp(MaterialApp(home: Cardiologistahmed()));
}

class Cardiologistahmed extends StatelessWidget {
    @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001067614587'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ...
        : 'Station Square, Khaled Ibn Al Waleed Tower No. 1.',
