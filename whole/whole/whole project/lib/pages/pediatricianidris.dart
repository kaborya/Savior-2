...
void main() {
  runApp(MaterialApp(home: Pediatricianidris()));
}

class Pediatricianidris extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001013399699'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Pediatrician, Assiut University. '
        : 'Al-Nasr Towers, Al-Waleediya, Assiut Second Section.',
