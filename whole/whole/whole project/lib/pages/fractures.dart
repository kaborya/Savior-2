...
void main() => runApp(const Fractures());
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 10),
                          Text(
                            "-A fracture is a broken bone. It needs medical care.",
                            style: TextStyle(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 10),
                          TreatmentDropdown(
                            title: "1 -Stop any bleeding",
                            description: "-Apply pressure to the wound with a sterile bandage, a clean cloth or a clean piece of clothing.",
                          ),
                          TreatmentDropdown(
                            title: "2 -Keep the injured area from moving",
                            description: "-Don't try to realign the bone or push a bone that's sticking out back in.",
                          ),
                          TreatmentDropdown(
                            title: "3 -apply a splint to the area above and below the fracture sites",
                            description:
                                "",
                          ),
                          TreatmentDropdown(
                            title: "4 -Apply ice packs to limit swelling and help relieve pain.",
                            description: "-Don't apply ice directly to the skin",
                          ),
                        ],
                      ),
                    ),
