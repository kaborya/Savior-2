...
void main() {
  runApp(MaterialApp(home: Ophthalmologistlist()));
}

class Ophthalmologistlist extends StatelessWidget {
  @override

    Widget build(BuildContext context) {
      final List<Map<String, String>> doctors = [
      {'name': 'Dr. Magdy Mohamed \n Mustafa', 'specialty': 'Ophthalmologist', 'experience': '2 years'},
      {'name': 'Dr. Hani Omar \n Elsodafy', 'specialty': 'Ophthalmologist', 'experience': '5 years'},
      {'name': 'Dr. Wael Suleiman', 'specialty': 'Ophthalmologist', 'experience': '8 years'},
      {'name': 'Dr. Peter Tharwat', 'specialty': 'Ophthalmologist', 'experience': '3 years'},
    ];
                            ...
                            children: [
                             ...
                             GestureDetector(
                                onTap: () {
                                  ...
                                  if (name.contains('Magdy')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Ophthmagdy()));
                                  } else if (name.contains('Hani')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Ophthhani()));
                                  } else if (name.contains('Wael')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Ophthwael()));
                                  } else if (name.contains('Peter')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Ophthpeter()));
                                  }
                                },
                                child: Container(
                                  width: 40,
