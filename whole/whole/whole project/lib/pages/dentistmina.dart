...
void main() {
  runApp(MaterialApp(home: Dentistmina()));
}

class Dentistmina extends StatelessWidget {
  @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001098977802'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Dr. Mina Victor Fayez Bachelor of Dental Surgery Member of The Faculty of Dental Surgery of The Royal Collage of Surgeon'
        : 'Al Hamraa Ath Thaneyah,Asyut 1, Assiut Governorate',
