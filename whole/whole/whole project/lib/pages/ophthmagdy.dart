...
void main() {
  runApp(MaterialApp(home: Ophthmagdy()));
}

class Ophthmagdy extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001097055094'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Professor of Ophthalmology, Corneal Surgery, Vision Correction and Cataract Surgery. '
        : 'Youlio 23, Al Hamraa Ath Thaneyah, Asyut.',
