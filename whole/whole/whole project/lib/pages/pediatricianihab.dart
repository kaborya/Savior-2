...
void main() {
  runApp(MaterialApp(home: Pediatricianihab()));
}

class Pediatricianihab extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001007086876'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Consultant specializing in pediatrics and neonatology.'
        : 'Thabet Street, in front of Koshary Galal, Assiut.',
