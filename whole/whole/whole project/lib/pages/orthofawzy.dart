...
void main() {
  runApp(MaterialApp(home: Orthofawzy()));
}

class Orthofawzy extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001156553809'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Orthopedic surgeon specializing in bone stem cells.'
        : '26th of July Street, in front of Sawiris Building.',
