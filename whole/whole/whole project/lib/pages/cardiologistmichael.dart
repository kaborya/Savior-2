...
void main() {
  runApp(MaterialApp(home: Cardiologistmichael()));
}

class Cardiologistmichael extends StatelessWidget {
   @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001225818835'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ...
        : '6 6th Street, 2nd of July, in front of Dar Al Maaref.',
