                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 10),
                          Text(
                            "Most of the time, insect stings are merely uncomfortable.",
                            style: TextStyle(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 10),
                          TreatmentDropdown(
                            title: "1 -Remove the stinger as quickly as possible.",
                            description: "",
                          ),
                          TreatmentDropdown(
                            title: "2 -Wash the area with soap and warm water",
                            description: "",
                          ),
                          TreatmentDropdown(
                            title: "3 -Apply a small amount of antibiotic, cream or gel to the wound if no known allergies or sensitivities.",
                            description:
                                "",
                          ),
                          TreatmentDropdown(
                            title: "4 -Apply a cold pack to site. Wrap pack in a thin, dry towel.",
                            description: "",
                          ),
                          TreatmentDropdown(
                            title: "5 -Watch for changes in condition -inclding breathing and responsiveness and signs of shock, and give care as appropriate.",
                            description: "",
                          ),
                        ],
                      ),
