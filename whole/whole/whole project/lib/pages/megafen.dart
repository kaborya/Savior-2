...
class Megafen extends StatelessWidget {
  @override
                ...
                children: [
                  ...
                  Center(
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/megafen.jpg',
                        width: isSmallScreen ? 330 : 100,
                        height: isSmallScreen ? 180 : 90,
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  _buildDescription(
                      'It is used as a pain reliever and antipyretic.'),
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildInfoItem('1-Stomach upset such as nausea or abdominal pain.'),
                      _buildInfoItem('2-Headache'),
                      _buildInfoItem('3-Dizziness'),
                    ],
                  ),
                ],
              ),
