...
class Optive extends StatelessWidget {
  @override
                ...
                children: [
                  ...
                  Center(
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/optive.jpeg',
                        width: isSmallScreen ? 430 : 70,
                        height: isSmallScreen ? 160 : 70,
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  _buildDescription(
                      'A natural tear substitute used in eye moisturizers, it helps maintain eye moisture by maintaining surface tension and protecting it from injury and inflammation. It also reduces eye allergy symptoms such as burning, itching, and a foreign body sensation.'),

                  // Side Effects
                  const SizedBox(height: 40),
                  _buildSectionTitle('Side Effects'),
                  _buildDescription(
                      'There are no side effects when using this medication. In very rare cases, the following may occur:'),
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildInfoItem('1-Blurred or double vision'),
                      _buildInfoItem('2-Eye discomfort'),
