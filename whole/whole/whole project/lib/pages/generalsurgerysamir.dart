...
void main() {
  runApp(MaterialApp(home: Generalsurgerysamir()));
}

class Generalsurgerysamir extends StatelessWidget {
    @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001125704153'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Consultant and Professor of General Surgery and Oncology.'
        : 'The station is opposite the bus stop next to Al Hussein Hotel.',
