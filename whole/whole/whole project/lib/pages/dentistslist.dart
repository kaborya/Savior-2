...
void main() {
  runApp(MaterialApp(home: Dentistslist()));
}

class Dentistslist extends StatelessWidget {
  @override

    Widget build(BuildContext context) {
    final List<Map<String, String>> doctors = [
      {'name': 'Dr. Mina Victor', 'specialty': 'Dentist', 'experience': '2 years'},
      {'name': 'Dr. Usama Thabet', 'specialty': 'Dentist', 'experience': '5 years'},
      {'name': 'Dr. Atef Abdel \n Karim', 'specialty': 'Dentist', 'experience': '8 years'},
      {'name': 'Dr. Mohamed Ahmed \n Sayed', 'specialty': 'Dentist', 'experience': '3 years'},
    ];
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  if (name.contains('Mina')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Dentistmina()));
                                  } else if (name.contains('Usama')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Dentistusama()));
                                  } else if (name.contains('Atef')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Dentistatef()));
                                  } else if (name.contains('Mohamed')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Dentistmohamed()));
                                  }
                                },
                                child: Container(
                                  width: 40,
