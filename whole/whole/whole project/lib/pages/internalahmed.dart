...
void main() {
  runApp(MaterialApp(home: Internalahmed()));
}

class Internalahmed extends StatelessWidget {
  @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001005550302'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Professor of Internal Medicine, Digestive System, Liver and Diabetes, Faculty of Medicine, Assiut University, Consultant of Digestive System Endoscopy at Al Rajhi Liver Hospital (Kasr Al Ainy), Member of the European Association for the Study of Liver Diseases'
        : 'Khaled Ibn Al-Walid Tower, first floor, Assiut',
