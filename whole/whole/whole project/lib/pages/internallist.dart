...
void main() {
  runApp(MaterialApp(home: Internallist()));
}

class Internallist extends StatelessWidget {
  @override

    Widget build(BuildContext context) {
    final List<Map<String, String>> doctors = [
      {'name': 'Dr. Ahmed Ashmawy', 'specialty': 'Internal Medicine', 'experience': '2 years'},
      {'name': 'Dr. Nour Abu Noir', 'specialty': 'Internal Medicine', 'experience': '5 years'},
      {'name': 'Dr. Wael Ahmed \n Abbas', 'specialty': 'Internal Medicine', 'experience': '8 years'},
      {'name': 'Dr. Baha Othman \n Musa', 'specialty': 'Internal Medicine', 'experience': '3 years'},
    ];
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  if (name.contains('Ahmed')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Internalahmed()));
                                  } else if (name.contains('Nour')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Internalnour()));
                                  } else if (name.contains('Wael')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Internalwael()));
                                  } else if (name.contains('Baha')) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Internalbaha()));
                                  }
                                },
                                child: Container(
                                  width: 40,
