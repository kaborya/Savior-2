...
class Ambroxol extends StatelessWidget {
  @override
                ...
                children: [
                  ...
                  Center(
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/Ambroxol.jpg',
                        width: isSmallScreen ? 260 : 100,
                        height: isSmallScreen ? 210 : 100,
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  _buildDescription(
                      'It is an expectorant that works to dissolve and break up phlegm by breaking down acidic mucopolysaccharide fibers, making the phlegm thinner and less viscous.'),
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildInfoItem('Gastrointestinal Disorders'),
                      _buildInfoItem('Vomiting'),
                      _buildInfoItem('Abdominal Pain'),
                    ],
                  ),
                ],
              ),
