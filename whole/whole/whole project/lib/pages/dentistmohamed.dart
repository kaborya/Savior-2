...
void main() {
  runApp(MaterialApp(home: Dentistmohamed()));
}

class Dentistmohamed extends StatelessWidget {
  @override
                          ...
                          child: ElevatedButton(
                            onPressed: ()  async {
                              final Uri phoneUri = Uri(
                                  scheme: 'tel',
                                  path: '+2001063920522'); // Replace with real number
...
Widget doctorInfoCard(String title) {
  ...
  child: Text(
    title == 'Info'
        ? 'Oral and Dental Medicine and Surgery Specialist. '
        : 'Al Hamraa Ath Thaneyah, Asyut 1',
